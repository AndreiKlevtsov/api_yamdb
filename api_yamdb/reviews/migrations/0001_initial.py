# Generated by Django 3.2 on 2023-05-02 09:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.SmallIntegerField(error_messages={'validators': 'Нельзя указывать год, который больше текущего.'}, validators=[django.core.validators.MaxValueValidator(2023)], verbose_name='Год')),
